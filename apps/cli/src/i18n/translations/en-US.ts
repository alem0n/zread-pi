...
export const enUS: TranslationKeys = {
  ...
  auth: {
    chooseType: 'Select authentication method',
    useOAuth: 'Sign in with account (OAuth)',
    useApiKey: 'Sign in with API key',
    apiKeyLabel: 'API Key',
    oauthLabel: 'OAuth',
    oauthHint: 'Subscription accounts (Claude Pro/Max, ChatGPT, Copilot, ...)',
    currentModel: 'Currently using this model',
    loggingIn: 'Logging in...',
    waiting: 'Waiting for browser authorization...',
    openUrl: 'Open in browser: {url}',
    deviceCode: 'Device code: {code} · Verification: {uri}',
    ...
    footerChoose: '↑↓ Select | enter Confirm | esc Back',
    footerApiKey: 'enter Log in | esc Back',
    footerConfigured: 'enter Use this model | l Log in again | d Log out | esc Back',
  },
  customModel: {
