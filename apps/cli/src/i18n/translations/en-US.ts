...
export const enUS: TranslationKeys = {
  cli: {
    ...
    verifyDesc: 'Verify generated Wiki (structure / content density / Mermaid / traceability / frontmatter / coverage)',
    verifyDetailDesc: 'Detail level to verify (minimal/low/medium/high/max; auto-detected by default)',
    verifyEnforceDesc: 'Treat content-gate failures as errors (default: list only)',
  },
  history: {
  ...
  verify: {
    skipped: 'SKIP {group} {message}',
    legacy: 'Legacy layout (no detail subdir); pages live in .zread-pi/wiki/',
    variant: 'Verifying variant: {variant}',
    overallPass: 'OVERALL PASS',
    overallFail: 'OVERALL FAIL',
    detailsPrefix: '  - ',
    summary: '{checks} check(s): {pass} passed / {fail} failed / {skip} skipped',
  },
  versionGuard: {
  ...
  blueprintDetail: {
    ...
    current: 'Current',
    intro:
      'The level sets the structure layer’s target parameters (sections / articles per section). Ranges are targets, not hard limits — the structure layer picks the level from the actual codebase and the LLM only names things.',
    minimal: 'Minimal',
    minimalDesc: '1 section (Overview) · 1 panorama article: must map modules and data flow with a Mermaid diagram (naming agents skipped)',
    low: 'Lite',
    lowDesc: '3-5 sections · 1-3 articles each',
    medium: 'Standard',
