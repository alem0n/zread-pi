...
| `test:trajectory`  | 轨迹模型层：replay 折叠（turn=agent / group 归属 / 请求统一编号 / 失败归属 / partial）、layout、timeline 四模式投影 + 选区过滤、搜索索引（多词交集 / 增量更新）、虚拟化窗口数学 + 稳定 key、格式化函数                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | 74/74                                   |
