...
- **轨迹视图的大规模真机渲染未做人工实测**：sticky 表头 / 滚轮缩放 / sub-pixel span 合并 /
  ...
  兜底（`test:components`，39 项，见 `MIGRATION.md` §26.11 与 `apps/browse/test/README.md`）；
