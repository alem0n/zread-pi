/**
 * 增量全文索引（节流提交 + 离屏记录匹配）。
 * 移植自 dsh ui-trajectory/src/client/trajectory-search-index.ts。
 */

import { trajectoryPreviewText } from './format.js';
import type { TrajectoryCellProps, TrajectoryTurnModel } from './types.js';
